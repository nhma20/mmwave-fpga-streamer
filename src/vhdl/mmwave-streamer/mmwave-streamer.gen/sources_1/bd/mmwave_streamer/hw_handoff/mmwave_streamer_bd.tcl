...
# module references:
# NOT_gate, UART_RX, data_parser, points_RAM, stream_controller
...
proc create_hier_cell_hier_0 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 stream_out_1
  ...
  create_bd_pin -dir I stream_out_TREADY_0
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins stream_out_1] [get_bd_intf_pins mmWaveStreamer_0/stream_out]
  ...
  connect_bd_net -net clk_0_1 [get_bd_pins clk] [get_bd_pins UART_RX_0/i_Clk] [get_bd_pins data_parser_0/i_Clk] [get_bd_pins mmWaveStreamer_0/ap_clk] [get_bd_pins points_RAM_0/i_Clk] [get_bd_pins stream_controller_0/clk]
  ...
  connect_bd_net -net i_in_0_1 [get_bd_pins i_in_0] [get_bd_pins NOT_gate_0/i_in] [get_bd_pins mmWaveStreamer_0/ap_rst_n] [get_bd_pins stream_controller_0/rst_n]
  ...
  connect_bd_net -net stream_out_TREADY_0_1 [get_bd_pins stream_out_TREADY_0] [get_bd_pins mmWaveStreamer_0/stream_out_TREADY] [get_bd_pins stream_controller_0/ready]
...
proc create_root_design { parentCell } {
  ...
  set stream_out_TREADY_0 [ create_bd_port -dir I stream_out_TREADY_0 ]

  # Create instance: hier_0
  create_hier_cell_hier_0 [current_bd_instance .] hier_0

  # Create interface connections
  connect_bd_intf_net -intf_net hier_0_stream_out_1 [get_bd_intf_ports stream_out] [get_bd_intf_pins hier_0/stream_out_1]
  ...
  connect_bd_net -net stream_out_TREADY_0_1 [get_bd_ports stream_out_TREADY_0] [get_bd_pins hier_0/stream_out_TREADY_0]
