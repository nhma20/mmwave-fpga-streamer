; ModuleID = '/home/nm/mmwave-fpga-streamer/src/hls/mmwave_streamer/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mmWaveStreamer_ir(%struct.ap_uint* %points_in, %"class.hls::stream"* %stream_out) local_unnamed_addr #0 {
entry:
  %points_in_copy = alloca [32 x %struct.ap_uint], align 512
  %stream_out_copy = alloca %"class.hls::stream", align 512
  %0 = bitcast %struct.ap_uint* %points_in to [32 x %struct.ap_uint]*
  call fastcc void @copy_in([32 x %struct.ap_uint]* %0, [32 x %struct.ap_uint]* nonnull align 512 %points_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  %1 = getelementptr inbounds [32 x %struct.ap_uint], [32 x %struct.ap_uint]* %points_in_copy, i32 0, i32 0
  call void @apatb_mmWaveStreamer_hw(%struct.ap_uint* %1, %"class.hls::stream"* %stream_out_copy)
  call fastcc void @copy_out([32 x %struct.ap_uint]* %0, [32 x %struct.ap_uint]* nonnull align 512 %points_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([32 x %struct.ap_uint]*, [32 x %struct.ap_uint]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([32 x %struct.ap_uint]*, [32 x %struct.ap_uint]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_mmWaveStreamer_hw(%struct.ap_uint*, %"class.hls::stream"*)

define void @mmWaveStreamer_hw_stub_wrapper(%struct.ap_uint*, %"class.hls::stream"*) #6 {
entry:
  %2 = bitcast %struct.ap_uint* %0 to [32 x %struct.ap_uint]*
  call void @copy_out([32 x %struct.ap_uint]* null, [32 x %struct.ap_uint]* %2, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  %3 = bitcast [32 x %struct.ap_uint]* %2 to %struct.ap_uint*
  call void @mmWaveStreamer_hw_stub(%struct.ap_uint* %3, %"class.hls::stream"* %1)
  call void @copy_in([32 x %struct.ap_uint]* null, [32 x %struct.ap_uint]* %2, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @mmWaveStreamer_hw_stub(%struct.ap_uint*, %"class.hls::stream"*)
