...
entry:
  ...
  %stream_out_copy1 = alloca %"class.hls::stream", align 512
  %0 = bitcast %struct.ap_uint* %points_in to [32 x %struct.ap_uint]*
  call fastcc void @copy_in([32 x %struct.ap_uint]* %0, [32 x %struct.ap_uint]* nonnull align 512 %points_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy1)
  %1 = getelementptr inbounds [32 x %struct.ap_uint], [32 x %struct.ap_uint]* %points_in_copy, i32 0, i32 0
  call void @apatb_mmWaveStreamer_hw(%struct.ap_uint* %1, %"class.hls::stream"* %stream_out_copy1)
  call fastcc void @copy_out([32 x %struct.ap_uint]* %0, [32 x %struct.ap_uint]* nonnull align 512 %points_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy1)
  ret void
}
