...
set ID 1
set hasByteEnable 0
set MemName mmWaveStreamer_points_buffer_V
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename points_in \
    op interface \
    ports { points_in_address0 { O 5 vector } points_in_ce0 { O 1 bit } points_in_q0 { I 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'points_in'"
}
}
